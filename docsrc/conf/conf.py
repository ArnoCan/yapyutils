...
# html_sidebars = {}
html_sidebars = {
   'default': ['localtoc.html', 'searchbox.html'],
   'index': ['localtoc.html', 'searchbox.html'],
   'install': ['localtoc.html', 'searchbox.html'],
   'setuplib_cli': ['localtoc.html', 'searchbox.html'],
   'setup_platforms_build_target': ['localtoc.html', 'searchbox.html'],
   'references': ['localtoc.html', 'searchbox.html'],

   'shortcuts': ['localtoc.html', 'apiref.html', 'searchbox.html'],
...
html_theme_options = {
    ...
    #
    # additional parameters by "default_white_with_green"
    #
