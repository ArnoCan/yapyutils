...
=========
   ...
   +==============+=============+============================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/yapyutils     |
   +--------------+-------------+--------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/yapyutils/|
   +--------------+-------------+--------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/yapyutils/      |
   +--------------+-------------+--------------------------------------------+
   | Documents    | sourceforge | https://yapyutils.sourceforge.io/          |
   +--------------+-------------+--------------------------------------------+
